<template>
	<view>
		...
		<!-- 登录 -->
		<image class="login-head" src="../../static/common/login-head.png" mode="widthFix" lazy-load></image>
	    <!-- 输入框+按钮 -->
		<view class="body">
	    	...
	    	@tap="submit" class="user-set-btn"
	    	 :class="{'user-set-btn-disable':disabled}" :disabled="disabled"> 登录</button>
	    </view>
		<!-- 登录状态切换 -->
